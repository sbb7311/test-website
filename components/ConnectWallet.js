...
import GoerliContractABI from "../abi/goerli.json";
import MainnetContractABI from "../abi/mainnet.json";
import GoerliTokenABI from "../abi/goerlitoken.json";
import MainnetTokenABI from "../abi/mainnettoken.json";


const CHAIN_ID = process.env.NEXT_PUBLIC_CHAIN_ID;
const NETWORK = CHAIN_ID === "1" ? "mainnet" : "goerli";
const contractABI = CHAIN_ID === "1" ? MainnetContractABI : GoerliContractABI;
const tokenABI = CHAIN_ID === "1" ? MainnetTokenABI : GoerliTokenABI;
...
export async function connectWallet() {
  ...
  return { provider, signer, web3Instance: instance, tokencontract, contract };
}
